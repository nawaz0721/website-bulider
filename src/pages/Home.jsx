      ...
      <main className="flex-1">
          ...
          <div className="grid gap-10 md:grid-cols-2 md:gap-16">
            <div className="flex flex-col justify-center space-y-4">
              ...
              <p className="max-w-[600px] text-muted-foreground md:text-xl">
                Create stunning, professional websites with our drag-and-drop builder. Choose from templates, customize
                to your needs, and publish in minutes.
              </p>
        ...
        <section id="features" className="p-5 py-16 md:py-24">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-xl text-muted-foreground">Everything you need to build professional websites</p>
          </div>
          <div className="grid gap-8 md:grid-cols-3">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Easily build your website with our intuitive drag and drop interface.</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">
                  No coding required. Simply drag elements onto your page, customize them, and create beautiful layouts
                  in minutes.
                </p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader>
                ...
                <CardDescription>Choose from a variety of professionally designed templates.</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Export your website as clean HTML, CSS, and JavaScript.</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <Card className="overflow-hidden">
              ...
              <CardHeader>
                ...
                <CardDescription>Showcase your work and skills with this modern portfolio template.</CardDescription>
              </CardHeader>
              <CardFooter>
            ...
            <Card className="overflow-hidden">
              ...
              <CardHeader>
                ...
                <CardDescription>Sell products online with this complete e-commerce template.</CardDescription>
              </CardHeader>
              <CardFooter>
            ...
            <Card className="overflow-hidden">
              ...
              <CardHeader>
                ...
                <CardDescription>Present your business professionally with this corporate template.</CardDescription>
              </CardHeader>
              <CardFooter>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <Card>
              <CardHeader>
                ...
                <div className="mt-4 flex items-baseline text-5xl font-bold">
                  $0<span className="ml-1 text-xl text-muted-foreground">/month</span>
                </div>
              </CardHeader>
              <CardContent>
            ...
            <Card className="border-primary">
              <CardHeader className="bg-primary/5">
                ...
                <div className="mt-4 flex items-baseline text-5xl font-bold">
                  $19<span className="ml-1 text-xl text-muted-foreground">/month</span>
                </div>
              </CardHeader>
              <CardContent>
                <ul className="space-y-3">
            ...
            <Card>
              <CardHeader>
                ...
                <div className="mt-4 flex items-baseline text-5xl font-bold">
                  $49<span className="ml-1 text-xl text-muted-foreground">/month</span>
                </div>
              </CardHeader>
              <CardContent>
                <ul className="space-y-3">
          ...
          <div className="grid gap-8 md:grid-cols-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Build beautiful websites without code. Start your free trial today.
              </p>
            </div>
            <div>
